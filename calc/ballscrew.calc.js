...
/* 볼스크류 데이터 — 압연 SFU 단일너트, DIN 69051 Form B (4회로) 기준.
   C(N):동정격 C0(N):정정격 dr(mm):골지름. 카탈로그 kgf → N(×9.80665).
   출처: SFU DIN 69051 Form B 표 / HIWIN 정밀연삭 카탈로그(S99TE22) 교차검증, 2026 대조.
   표준 SFU에 없는 비표준 리드(20×10·20×20·25×20·32×20·40×20)는 미수록. */
const BS_DATA = {
  '16x5' :{C:13533,  C0:29933,  dr:13.5},
  '16x10':{C:10818,  C0:23544,  dr:13.5},
  '20x5' :{C:15210,  C0:38001,  dr:16.9},
  '25x5' :{C:16907,  C0:48093,  dr:21.5},
  '25x10':{C:28967,  C0:71540,  dr:21.5},
  '32x10':{C:47121,  C0:119720, dr:27.3},
  '40x10':{C:52948,  C0:152003, dr:34.0},
  '50x10':{C:58879,  C0:192338, dr:43.0},
  '50x20':{C:70039,  C0:221521, dr:43.0},
  '63x10':{C:65892,  C0:248661, dr:55.0},
  '63x20':{C:112231, C0:359436, dr:55.0},
};
