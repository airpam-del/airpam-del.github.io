...
const GOLDEN = [
  { label: 'simple 경하중 → size20 적합',
    ...
    expect: { P: 240, size: 20, L10km: 39369.85300202546, years: 19.206305371163342, ratio: 12.225,
  ...
  { label: 'simple 중하중·2블록 → size45 수명부족',
    ...
    expect: { P: 1462.5, size: 45, L10km: 12212.48934708897, years: 1.7873330621544563, ratio: 8.99008547008547,
      verdict: '수명 부족', safety: '주의 — 안전율은 충족하나 수명이 5년 미만입니다', nRows: 1 } },
  { label: 'advanced 모멘트하중 → size45 적합 (비교행 2개)',
    ...
    expect: { P: 670, size: 45, L10km: 127018.62703058553, years: 22.152538326617844, ratio: 19.623880597014924,
  ...
  { label: 'simple 과하중 → size45 부적합',
    ...
    expect: { P: 16200, size: 45, L10km: 8.985593725738134, years: 0.002191779291490588, ratio: 0.811604938271605,
